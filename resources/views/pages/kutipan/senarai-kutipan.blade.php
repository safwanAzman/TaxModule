                            ...
                            <x-slot name="tbody">
                                ...
                                <tr>
                                    ...
                                    <x-general.table-body colspan="" class="text-sm text-gray-500 uppercase">
                                        <div class="flex justify-center">
                                            ...
                                            <div class="bg-red-500 hover:bg-grey text-blue-500-darkest font-bold py-2 px-2 rounded-full flex cursor-pointer ml-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4 text-white text-center">
                                ...
                                <tr class="bg-orange-100">
                                    ...
                                    <x-general.table-body colspan="" class="text-gray-500 uppercase">
                                        <p class="font-semibold text-xs">Bilangan Bil: <span class="font-semibold">1</span></p>
                                    </x-general.table-body>
                                    <x-general.table-body colspan="" class="text-sm text-gray-500 uppercase">
                                        <p class="font-semibold text-xs">Jumlah Perlu Bayar: <span class="font-semibold">RM 1249.60</span></p>
                                    </x-general.table-body>        
                                </tr>                       
                            </x-slot>
            ...
            <div class="bg-white shadow-lg mt-5 p-4">
                <div class="pt-4">
                    ...
                    <div class="pt-2 leading-7">
                        <p>No Rujukan : <span class="font-semibold">C0020000014</span></p>
                        <p>Nama : <span class="font-semibold">Muhammad Rahim Bin Ali</span></p>
                        <p>IC : <span class="font-semibold">981212107022</span></p>
                        <p>Alamat : <span class="font-semibold">Lot 7878 jalan kampung 43000 kajang selangor</span></p>
                    </div>
                </div>
                <div class="pt-4">
                    <x-general.table>
                        ...
                        <div class="bg-blue-500 p-4">
                            <div class="flex justify-between">
                                ...
                                <div class="flex">
                                    ...
                                    <button class="bg-white hover:bg-grey text-blue-500-darkest font-semibold py-1 px-4 rounded flex ml-2 transition duration-150">
            ...
            <div class="bg-white shadow-lg p-2 mt-5">
                <div class="pt-2">
                    <div class="w-full overflow-hidden shadow-xs">
                        <div class="bg-blue-500 p-4">
                            <div class="flex justify-between">
                                <h1 class="text-white text-base font-semibold">Terimaan Semasa : <span class="font-semibold">0.00</span></h1>

                                <button class="bg-white hover:bg-grey text-blue-500-darkest font-bold py-2 px-4 rounded flex cursor-pointer" style="width: 150px;">
                                    ...
                                    <span class="text-blue-500 text-xs flex items-center">Simpan Bayaran</span>
                                </button>
                    ...
                    <div class="bg-gray-100 p-4">
                        <div class=" flex justify-between">
                            ...
                            <div class="border px-6">
                                <p class="font-semibold text-xl">2,046.60</p>
                            </div>
                        </div>
                        <div class="flex justify-between pt-3">
                            <p class="font-semibold text-lg">Baki Dipulangkan</p>
                            <div class="border px-6">
                                <p class="font-semibold text-xl">0.00</p>
                            </div>
                        </div>
