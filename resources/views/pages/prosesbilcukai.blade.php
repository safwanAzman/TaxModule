        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
                ...
                <thead >
                    ...
                    <th class="px-4 py-3">Bilangan Ditemui = <span class="font-semibold text-base"> 1</span> | Bilangan Dipapar = <span class="font-semibold text-base text-blue-500"> 0</span> </th>
                    <th class="px-4 py-3"></th>
                    <th class="px-4 py-3"></th>
                    <th class="px-4 py-3 flex justify-end">
                        <a href="/DownloadResit" class="bg-blue-500 hover:bg-grey text-blue-500-darkest font-bold py-2 px-4 rounded flex">
        ...
        <div class="bg-white shadow-lg mt-4">
          <a class="flex items-center justify-between p-4 text-sm font-semibold text-purple-100 bg-blue-600 shadow-md focus:outline-none focus:shadow-outline-purple">
            ...
            <div class="p-4">
                ...
                <div class="pt-4 flex">
                    <a href="#" class="bg-green-500 hover:bg-grey text-blue-500-darkest font-bold py-2 px-4 rounded flex cursor-pointer" style="width: 200px;">
